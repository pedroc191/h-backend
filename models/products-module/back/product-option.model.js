...
let productOptionSchema = mongoose.Schema({
    ...
    values      : [{ type: mongoose.Schema.Types.ObjectId   , default: null, ref: 'back_product_option_value' }],
    translate   : { type: [{
...
module.exports = mongoose.model( 'back_product_option', productOptionSchema );