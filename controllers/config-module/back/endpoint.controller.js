...
async function findDocument(req, res){
    ...
    if( format_data.is_valid ){
        ...
        await h_crud.findDocument('Endpoint', backEndpointService, { _id: format_data.body_object.id }, req.body.fields, req.body.options).then( async (result_document) => {
        ...
        res.status(400).send( h_response.request( false, format_data.error_fields, 400, 'Error: Validate Data', 'Endpoint fields required not validated' ) );
    }
};
/**
 * 
...
async function listDocuments(req, res){
    ...
    await h_crud.listDocuments('Endpoint', backEndpointService, req.body.query, req.body.fields, req.body.options).then( async (result_document) => {
...
async function createDocument(req, res){
    ...
    if( format_data.is_valid ){
        ...
        await h_crud.createDocument('Endpoint', backEndpointService, { name: format_data.body_object.name }, format_data.body_object, false).then( async (result_document) => {
...
async function updateDocument(req, res){
    ...
    if( format_data.is_valid ){
        ...
        format_data.body_object.handle = format_data.body_object.name != null ? h_format.slug( format_data.body_object.name ) : null;
        await h_crud.updateDocument('Endpoint', backEndpointService, { _id: document_id }, format_data.body_object, false).then( async (result_document) => {
...
async function updateDocumentStatus(req, res){
    ...
    if( format_data.is_valid ) {
        ...
        await h_crud.updateDocument('Endpoint', backEndpointService, { _id: document_id }, format_data.body_object).then( async (result_document) => {
